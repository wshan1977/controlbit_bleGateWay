...
| 외관 (조립 상태) | PCB 단품 | 케이스 내부 |
| --- | --- | --- |
| ![게이트웨이 외관](assets/gateway_main.png) | ![PCB 상면](assets/pcb_top.png) | ![케이스 내부 PCB 장착 상태](assets/pcb_in_case.png) |
| 케이스 + 후면 브라켓 포함 | RJ45 · USB-C · LED 위치 확인 가능 | 케이스 내 PCB 장착 상태 |
